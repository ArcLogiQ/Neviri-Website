...
const SolutionsPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Enterprise Cloud Solutions: VMs, Managed MongoDB & MySQL | Neviri
        </title>
        <meta
          name="description"
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <section className="relative py-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-sky-600/10 blur-[120px] rounded-full pointer-events-none -z-10 mix-blend-multiply"></div>
            ...
            <div className="relative max-w-7xl mx-auto text-center flex flex-col items-center z-10">
              <div className="inline-flex items-center px-5 py-2.5 bg-[#EEF2FF] border border-[#BFDBFE] text-[#3B82F6] rounded-full text-xs font-black uppercase tracking-widest mb-10 hover:scale-110 hover:bg-[#DBEAFE] transition-all duration-500 shadow-sm">
                <span className="w-2 h-2 bg-sky-600 rounded-full mr-3 animate-pulse shadow-[0_0_8px_#3B82F6]"></span>
              ...
              <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-extrabold text-[#0F172A] mb-8 leading-[1.1] tracking-tight">
                ...
                <span className="relative inline-block mt-2 group cursor-default">
                  ...
                  <span className="relative text-white px-5 py-1 drop-shadow-sm">
                    Enterprise Cloud
                  </span>
                </span>
              </h1>
              ...
              <p className="text-lg md:text-2xl text-[#64748B] mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
                Deploy lightning-fast Virtual Machines, auto-scaling managed
                databases, and highly secure networking environments. The
                ultimate cloud-native platform built for developers and growing
                enterprises.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-5 mb-10">
                {[
                  ...
                  <div
                    key={idx}
                    className={`bg-white/80 backdrop-blur-md border-2 border-[#E2E8F0] ${item.hoverBorder} rounded-full px-6 py-3 text-[#0F172A] text-sm font-bold hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(59,130,246,0.12)] transition-all duration-400 cursor-pointer flex items-center group`}
                  >
                    <item.icon
                      className={`w-5 h-5 mr-2.5 ${item.color} group-hover:scale-125 transition-transform duration-400`}
                    />
                    {item.text}
                  </div>
                ))}
            ...
            <div className="relative max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-[#64748B] max-w-3xl mx-auto font-medium">
                  Whether you need raw compute power, optimized relational
                  databases, or flexible NoSQL document storage, our cloud
                  ecosystem provides production-ready solutions instantly.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    theme: {
                      ...
                      shadow: "hover:shadow-[0_15px_40px_rgba(59,130,246,0.1)]",
                      iconBg: "group-hover:bg-sky-600",
                      iconBorder: "group-hover:border-[#3B82F6]",
                      text: "text-[#3B82F6]",
                      fill: "fill-[#EFF6FF]",
                    },
                  },
                  {
                    ...
                    theme: {
                      ...
                      shadow: "hover:shadow-[0_15px_40px_rgba(6,182,212,0.1)]",
                      iconBg: "group-hover:bg-[#06B6D4]",
                      iconBorder: "group-hover:border-[#06B6D4]",
                      text: "text-[#06B6D4]",
                      fill: "fill-[#ECFEFF]",
                    },
                  },
                  ...
                  <div
                    key={index}
                    className={`bg-white p-8 md:p-10 rounded-[2rem] border-2 border-[#F1F5F9] ${service.theme.border} transition-all duration-500 ease-out ${service.theme.shadow} hover:-translate-y-2 group`}
                  >
                    <div className={`flex items-center gap-5 mb-6`}>
                      <div
                        className={`w-16 h-16 bg-[#F8FAFC] rounded-2xl flex items-center justify-center flex-shrink-0 ${service.theme.iconBg} group-hover:rotate-6 group-hover:scale-110 transition-all duration-500 ease-out border border-[#E2E8F0] ${service.theme.iconBorder}`}
                      >
                        <service.icon
                          className={`w-8 h-8 ${service.theme.text} group-hover:text-white transition-colors duration-300`}
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {service.features.map((feature, fIndex) => (
                        <div key={fIndex} className="flex items-center gap-3">
                          <CheckCircle2
                            className={`w-5 h-5 ${service.theme.text} ${service.theme.fill} flex-shrink-0`}
                          />
          ...
          <section className="relative py-20 px-4 sm:px-6 lg:px-8">
            <div className="relative max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-extrabold text-[#0F172A] mb-6 tracking-tight">
                  Engineered for{" "}
                  <span className="bg-gradient-to-r from-[#3B82F6] to-[#06B6D4] px-3 text-white inline-block transform -skew-x-2 shadow-sm">
                    Cloud-Native
                  </span>{" "}
                  Excellence
                </h2>
                <p className="text-xl text-[#64748B] max-w-2xl mx-auto font-medium">
                  Features that simplify infrastructure management across
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 bg-gradient-to-br from-[#0D1B2A] via-[#0A1628] to-[#071020] p-8 md:p-10 rounded-[2.5rem] relative overflow-hidden group border border-[#1E293B] hover:border-[#22D3EE]/60 transition-all duration-500 ease-out hover:shadow-[0_20px_60px_rgba(34,211,238,0.15)] hover:-translate-y-2 flex flex-col gap-8">
                  ...
                  <div className="relative z-10 flex flex-col sm:flex-row sm:items-start gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-[#7E9BB5] font-medium text-base md:text-lg leading-relaxed max-w-xl">
                        Manage your VMs, databases, and networks instantly from
                        the terminal with our powerful Neviri CLI.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 w-full bg-[#020B14] rounded-2xl border border-[#1E293B] group-hover:border-[#22D3EE]/30 transition-colors duration-500 overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="flex items-center justify-between px-5 py-3 border-b border-[#1E293B] bg-[#040F1A]">
                      ...
                      <span className="text-[#334155] text-xs font-mono tracking-wider">
                        neviri — bash
                      </span>
                      <div className="w-16" />
                    </div>
                    ...
                    <div className="px-6 py-5 font-mono text-sm space-y-2 leading-relaxed">
                      {/* Line 1 */}
                      <div className="flex items-center gap-2">
                        <span className="text-[#22D3EE] font-bold select-none">
                          ❯
                        </span>
                      ...
                      <div className="flex items-center gap-2 pl-5 text-[#475569] text-xs">
                        ...
                        <span>
                          VM <span className="text-[#E2E8F0]">web-server</span>{" "}
                          created in{" "}
                          <span className="text-[#E2E8F0]">in-central-1</span>
                        </span>
                      </div>
                      ...
                      <div className="pl-5 space-y-1 text-xs">
                        ...
                        <div className="flex gap-6 text-[#94A3B8]">
                          <span className="w-28 text-[#E2E8F0]">
                            web-server
                          </span>
                ...
                <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border-2 border-[#F1F5F9] hover:border-[#3B82F6] transition-all duration-500 ease-out hover:shadow-[0_15px_40px_rgba(59,130,246,0.1)] hover:-translate-y-2 group flex flex-col">
                  <div className="w-14 h-14 bg-[#F8FAFC] rounded-2xl flex items-center justify-center group-hover:bg-sky-600 group-hover:rotate-6 group-hover:scale-110 transition-all duration-500 mb-6 border border-[#E2E8F0] group-hover:border-[#3B82F6]">
                  ...
                  <p className="text-[#64748B] leading-relaxed font-medium">
                    Granular real-time monitoring. Track CPU, RAM, disk I/O, and
                    query performance natively in the dashboard.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-[#3B82F6] to-[#06B6D4] p-8 md:p-10 rounded-[2.5rem] transition-all duration-500 ease-out hover:shadow-[0_20px_50px_rgba(59,130,246,0.4)] hover:-translate-y-3 group flex flex-col">
                  ...
                  <p className="text-white/90 leading-relaxed font-medium">
                    Usage-based hourly pricing with resource caps. Say goodbye
                    to complex, unpredictable cloud invoices.
                  </p>
                </div>
                ...
                <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border-2 border-[#F1F5F9] hover:border-[#06B6D4] transition-all duration-500 ease-out hover:shadow-[0_15px_40px_rgba(6,182,212,0.1)] hover:-translate-y-2 group flex flex-col">
                  ...
                  <p className="text-[#64748B] leading-relaxed font-medium">
                    Distribute traffic across your VMs with highly available,
                    health-checking Layer 4 and Layer 7 Load Balancers.
                  </p>
                </div>
                ...
                <div className="md:col-span-3 bg-white p-8 md:p-10 rounded-[2.5rem] border-2 border-[#F1F5F9] hover:border-[#3B82F6] transition-all duration-500 ease-out hover:shadow-[0_15px_40px_rgba(59,130,246,0.1)] hover:-translate-y-1 group flex flex-col md:flex-row items-start md:items-center gap-8">
                  <div className="w-20 h-20 bg-[#F8FAFC] rounded-[1.5rem] flex items-center justify-center group-hover:bg-sky-600 group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500 flex-shrink-0 border border-[#E2E8F0] group-hover:border-[#3B82F6]">
                    <ShieldCheck className="h-10 w-10 text-[#64748B] group-hover:text-white transition-colors duration-300" />
                  </div>
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold mb-3 text-[#0F172A]">
                      Zero-Trust Security
                    </h3>
                    <p className="text-[#64748B] leading-relaxed font-medium text-lg max-w-3xl">
                      Isolate environments using Private Cloud (VPC), configure
                      strict Cloud Firewalls, and utilize IAM roles right out of
                      the box.
                    </p>
                  </div>
                </div>
          ...
          <section className="relative py-20 px-4 sm:px-6 lg:px-8">
            <div className="relative max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-[#64748B] max-w-2xl mx-auto font-medium">
                  From simple web hosting on VMs to complex microservices
                  requiring managed databases.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    title: "SaaS Startups",
                    description:
                      "Launch fast with easily scalable VMs and managed MongoDB clusters. Minimize DevOps overhead.",
                    colorClass: "hover:border-[#3B82F6]",
                    bgHoverClass: "group-hover:bg-sky-600",
                    shadowClass:
                  ...
                  },
                  {
                    ...
                    title: "E-Commerce",
                    description:
                      "Handle seasonal traffic spikes using Auto-scaling Compute and highly available MySQL replicas.",
                  ...
                  },
                  {
                    ...
                    title: "Dev & Test Env",
                    description:
                      "Spin up low-cost development virtual machines and clone database clusters in minutes.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Deploy secure, VPC-isolated architecture with strict IAM controls and real-time observability.",
                    colorClass: "hover:border-[#3B82F6]",
                    bgHoverClass: "group-hover:bg-sky-600",
                    shadowClass:
                      "hover:shadow-[0_15px_40px_rgba(59,130,246,0.12)]",
                  ...
                  >
                    <div
                      className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 transition-all duration-500 ease-out bg-[#F8FAFC] border border-[#E2E8F0] ${useCase.bgHoverClass} group-hover:border-transparent`}
                    >
            ...
            <div className="relative max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-[#64748B] font-medium">
                  Everything you need to know about our VMs, databases, and
              ...
              <div className="space-y-4">
                {[
                  {
                    question:
                      "What is the difference between Virtual Machines and Managed Databases?",
                    answer:
                      "Virtual Machines (VMs) provide you with raw compute power and full root access where you manage the OS and software. Managed Databases (MongoDB, MySQL) are Platform-as-a-Service (PaaS) offerings where we handle the database installation, security patches, clustering, and backups for you.",
                  },
                  {
                    question:
                      "How quickly do Virtual Machines and Clusters provision?",
                    answer:
                      "Our infrastructure is highly optimized. Virtual Machines typically provision and boot up in under 45 seconds. Complex Managed Database clusters (like a 3-node MongoDB Replica Set) are usually ready for connections within 2 to 3 minutes.",
                  },
                  {
                    question:
                      "Can I migrate my existing databases to Neviri Cloud?",
                    answer:
                      "Yes! We provide seamless migration tools and dedicated technical support for moving existing MongoDB, MySQL, and PostgreSQL workloads. We ensure zero to minimal downtime during the transfer.",
                  },
                  {
                    question: "How does the pricing and billing model work?",
                    answer:
                      "Billing is entirely usage-based with hourly granularity. You only pay for the exact hours your VMs, databases, or storage volumes exist. We also offer monthly predictable caps so you never exceed your budget.",
                  },
                  {
                    question: "Are my virtual machines and databases secure?",
                    answer:
                      "Absolutely. All compute and database resources can be deployed within a private Virtual Private Cloud (VPC), isolated from the public internet. We also offer cloud firewalls, DDoS protection, and automated encryption at rest and in transit.",
                  },
                  {
                    question: "How are automated database backups handled?",
                    answer:
                      "Automated backups are a core feature of our Managed Databases. We take daily snapshots and retain transaction logs, allowing for Point-in-Time Recovery (PITR). You can restore your data to the exact minute an accidental deletion occurred.",
                  },
                ].map((faq, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span
                          className={`text-lg md:text-xl font-bold text-[#0F172A] pr-8 transition-colors duration-300 ${theme.textHover}`}
                        >
                          {faq.question}
                        </span>
                        <div
                          className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 transition-colors duration-300 ${
                            openFAQ === index
                              ? theme.iconBgActive
                              : `${theme.iconBgInactive} ${theme.iconBgHover}`
                          }`}
                        >
                          <ChevronDown
                            className={`w-5 h-5 transition-transform duration-300 ${
                              openFAQ === index
                                ? `transform rotate-180 ${theme.chevronActive}`
                                : theme.chevronInactive
                            }`}
                          />
                        </div>
                      </button>
          ...
          <section className="relative py-24 px-4 sm:px-6 lg:px-8">
            <div className="relative max-w-5xl mx-auto text-center bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0F172A] py-16 px-6 sm:px-12 rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-2 border-[#334155] hover:border-[#3B82F6]/50 transition-colors duration-500 overflow-hidden">
              ...
              <p className="text-xl text-[#94A3B8] mb-10 max-w-3xl mx-auto font-medium relative z-10">
                ...
                Join thousands of developers and tech-forward businesses scaling
                their applications on Neviri&apos;s high-performance cloud
                platform.
              </p>
