        ...
        <section>
          <div className="bg-white rounded-[2.5rem] p-8 md:p-16 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
            ...
            <div className="mt-16 text-center">
              ...
              <Link href="/signup" className="inline-flex items-center gap-2 bg-[#0F172A] hover:bg-emerald-600 text-white px-8 py-4 rounded-xl text-base font-bold transition-all shadow-md">
