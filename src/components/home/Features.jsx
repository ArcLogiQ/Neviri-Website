...
import { Server, Network, Eye, Shield, Zap, Globe } from "lucide-react";
...
const Features = () => {
  ...
  const features = [
    {
      ...
      description:
        "Elastic virtual machines and containers with full data sovereignty guarantees. Deploy with predictable performance and complete control.",
    ...
    },
    {
      ...
      description:
        "Software-defined networking with private VPCs, secure segmentation, and compliance data pathways. Built for compliance-first architectures.",
    ...
    },
    {
      ...
      description:
        "Unified monitoring platform with regulatory intelligence. Real-time compliance status alongside performance metrics in isolated dashboards.",
    ...
    },
    {
      ...
      description:
        "Built-in compliance frameworks for regulated industries. Automated governance, threat detection, and strict policy enforcement.",
    ...
    },
    {
      ...
      description:
        "High-performance NVMe storage with automatic horizontal scaling and intelligent load balancing for your heaviest traffic spikes.",
    ...
    },
    {
      ...
      title: "Global Reach",
      description:
        "Deploy in multiple physically isolated regions worldwide for optimal performance, keeping data perfectly sovereign and local.",
  ...
  return (
    <section
      id="features"
      className="relative bg-white py-24 px-6 lg:px-12 font-sans antialiased selection:bg-sky-600/30"
    >
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-slate-500 font-medium max-w-xl leading-relaxed">
            Deploy with predictable performance, absolute security, and complete
        ...
        <div className="relative w-full max-w-3xl mx-auto h-[600px] md:h-[700px] mt-10">
          ...
          {/* Central Hub Core */}
          <div
            className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center transition-all duration-700 ${activeFeature !== null ? "opacity-0 scale-90 blur-sm" : "opacity-100 scale-100"}`}
          >
            <div
              className="absolute w-64 h-64 bg-sky-600/10 rounded-full animate-ping"
            ...
            {activeFeature !== null && (
              <div className="flex flex-col h-full text-center items-center">
                ...
                <div className="inline-flex items-center px-4 py-2 bg-slate-50 border border-slate-100 rounded-full text-[10px] font-black uppercase tracking-widest text-[#0F172A]">
                  <span className="w-2 h-2 rounded-full bg-sky-600 mr-2 animate-pulse"></span>
            ...
            return (
              ...
              >
                <div className="relative group cursor-pointer flex flex-col items-center">
                  ...
                  {isActive && (
                    <div className="absolute inset-0 bg-sky-600 rounded-full blur-xl opacity-40"></div>
                  )}
                  ...
                  <div
                    className={`absolute top-[110%] w-32 text-center transition-opacity duration-300 ${activeFeature !== null ? "opacity-0" : "opacity-100"}`}
                  >
